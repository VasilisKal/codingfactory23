 ...
 * Αν μία δεξαμενή έχει λιγότερο από 1/4 καύσιμα, τότε
 * ανάβει πορτοκαλί σήμα.
 * Ενώ, αν και οι δύο δεξαμενές έχουν < 1/4,
...
public class OrangeRedSignalApp {
    public static void main(String[] args) {
        ...
        boolean isTank1LTQuarter = false; // LT = Less Than
